...
3. Run tests
`devcontainer exec --workspace-folder . pytest tests`
...
`devcontainer exec --workspace-folder . pytest --log-file=pytest1.log --log-file-level=DEBUG tests/tests/test_exclude_disabled.py` | save debug logs in pytest1.log
